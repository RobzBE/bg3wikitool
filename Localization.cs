...
internal static class Localization
{
    ...
    private static readonly Dictionary<string, (string English, string Dutch)> Texts = new()
    {
        ...
        ["BenchmarkNote"] = ("Worst case uses the strongest hostile benchmark per act. Average uses the act's representative level/proficiency and primary ability baseline. On attack rolls natural 1 always misses and natural 20 always hits, unless critical immunity makes the 20 a regular roll against AC. Ordinary combat saving throws have no automatic result on natural 1 or 20. Spell effect uses your weakest DEX/CON/WIS save.", "Worst case gebruikt de sterkste vijandelijke benchmark per act. Average gebruikt het representatieve level/proficiency en de primaire ability van die act. Bij attack rolls mist een natuurlijke 1 altijd en raakt een natuurlijke 20 altijd, tenzij critical immunity de 20 als gewone worp tegen AC behandelt. Gewone combat saving throws hebben geen automatisch resultaat op een natuurlijke 1 of 20. Spell effect gebruikt je zwakste DEX/CON/WIS-save."),
