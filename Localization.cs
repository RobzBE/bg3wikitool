...
internal static class Localization
{
    ...
    {
        ["SaveGameLink"] = ("BG3 savegame link", "BG3-savegamekoppeling"),
        ["LinkNewestSave"] = ("Link newest", "Link nieuwste"),
        ["BrowseSave"] = ("Browse...", "Bladeren..."),
        ["SyncSave"] = ("Sync now", "Sync nu"),
        ["UnlinkSave"] = ("Unlink", "Ontkoppel"),
        ["SaveNotLinked"] = ("SAVE: not linked (optional)", "SAVE: niet gekoppeld (optioneel)"),
        ["SaveLinked"] = ("SAVE: linked - {0}", "SAVE: gekoppeld - {0}"),
        ["SaveSynced"] = ("SAVE: {0} synced - {1}", "SAVE: {0} gesynchroniseerd - {1}"),
        ["SaveSyncing"] = ("SAVE: reading latest manual/quicksave...", "SAVE: nieuwste manual/quicksave lezen..."),
        ["SaveWaiting"] = ("SAVE: change detected - waiting for the write to complete...", "SAVE: wijziging gedetecteerd - wachten tot schrijven klaar is..."),
        ["SaveMissing"] = ("SAVE: linked file is missing", "SAVE: gekoppeld bestand ontbreekt"),
        ["SaveSyncFailed"] = ("SAVE: sync failed - click Sync now", "SAVE: sync mislukt - klik Sync nu"),
        ["SaveWatcherError"] = ("SAVE: automatic monitoring unavailable", "SAVE: automatische bewaking niet beschikbaar"),
        ["SaveOptional"] = ("Optional. The app works normally without Baldur's Gate 3 or a local save.", "Optioneel. De app werkt normaal zonder Baldur's Gate 3 of een lokale save."),
        ...
        ["BaseAbilities"] = ("ABILITY SCORES", "ABILITY SCORES"),
        ["AbilityScoresAtLevel"] = ("LEVEL {0} ABILITY SCORES", "ABILITY SCORES OP LEVEL {0}"),
        ["AbilityTotal"] = ("Total {0}", "Totaal {0}"),
        ...
        ["AcDraconicResilience"] = ("13 Draconic Resilience {0} DEX", "13 Draconic Resilience {0} DEX"),
