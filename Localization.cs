...
internal static class Localization
{
    ...
    private static readonly Dictionary<string, (string English, string Dutch)> Texts = new()
    {
        ...
        ["BenchmarkNote"] = ("Worst case uses the strongest hostile benchmark per act. Average uses the act's representative level/proficiency and primary ability baseline. Natural 1 always misses and natural 20 always hits, unless critical immunity turns 20 into a regular roll against AC. Spell effect uses your weakest DEX/CON/WIS save.", "Worst case gebruikt de sterkste vijandelijke benchmark per act. Average gebruikt het representatieve level/proficiency en de primaire ability van die act. Een natuurlijke 1 mist altijd en een natuurlijke 20 raakt altijd, tenzij critical immunity de 20 als gewone worp tegen AC behandelt. Spell effect gebruikt je zwakste DEX/CON/WIS-save."),
